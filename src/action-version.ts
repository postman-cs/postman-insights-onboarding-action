...
// a constant undefined, so the guard below is inert there -- the committed dist
// stays a pure function of source and does not churn on every version bump.
declare const __SEA_VERSION__: string | undefined;

// Resolve this action's version. Prefer the SEA-embedded constant; otherwise read
// the packaged package.json at runtime (GitHub Action / npm paths).
