...
The CLI publishes as `@postman/onboarding-insights` with versions that match the GitHub release tag. The rolling `v1` alias updates the action channel and skips npm publishing.
